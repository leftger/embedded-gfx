...
//!
//! Adapted from Bevy (`bevy_gizmos::simplex_stroke_font`), licensed under MIT / Apache-2.0.
//! Original Hershey vector font data is in the public domain (<https://paulbourke.net/dataformats/hershey/>).

use core::ops::Range;

/// A stroke font containing glyphs for the 95 printable ASCII codes (32..=126).
#[derive(Clone, Copy)]
...
pub const SIMPLEX_DESCENDER_DEPTH: f32 = 7.0;
pub const SIMPLEX_HEIGHT: f32 = SIMPLEX_CAP_HEIGHT + SIMPLEX_DESCENDER_DEPTH;

pub const TAB_WIDTH_IN_SPACES: usize = 4;
...
pub const SIMPLEX_STROKES: [Range<usize>; 188] = [
    0..2,
    2..7,
    7..9,
    9..11,
